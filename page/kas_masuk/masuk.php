      ...
      <div class="col-md-12">
          ...
          <div class="panel panel-primary">
              ...
              <div class="panel-body">
                            ...
                            <?php
                             ...
                             ?>
                              <tr class="odd gradeX">
                                  ...
                                  <td>
                                    <a href="?page=masuk&aksi=ubah&id=<?php echo $data['kode'];?>" class="btn btn-info"><i class="fa fa-edit"></i> Ubah</a>
                ...
                <a href="./laporan/laporan_kas_masuk_exel.php" target="blank" class="btn btn-default" style="margin-top: 8px"><i class="fa fa-print"></i> ExportToExcel</a>
