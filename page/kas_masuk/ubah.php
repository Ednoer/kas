              ...
              <div class="row">
                  <div class="col-md-12">
                      ...
                      <form role="form" method="POST">
                          ...
                          <div class="form-group">
                              <label>Jumlah</label>
                              <input class="form-control" type="number" name="jml" value="<?php echo $tampil['jumlah'];?>"/>
...
<?php
  ...
  if ($simpan) {
    $sql = $koneksi->query("update kas set kode='$kode', keterangan='$ket', tgl='$tgl', jumlah='$jml', jenis='masuk', keluar=0 where kode='$kode'");
